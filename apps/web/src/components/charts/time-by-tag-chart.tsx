...
export function TimeByTagChart({
  buckets,
  isLoading,
}: {
  ...
  return (
    <section className="flex flex-col gap-2 rounded-lg bg-muted/30 p-4" aria-label="Time per tag">
      <h3 className="text-sm font-medium text-foreground">Time per tag</h3>
      {isLoading ? (
